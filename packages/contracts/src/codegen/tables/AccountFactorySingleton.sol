...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("AccountFactorySi")));
bytes32 constant AccountFactorySingletonTableId = _tableId;

library AccountFactorySingleton {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("AccountFactorySingleton", _fieldNames);
  }
